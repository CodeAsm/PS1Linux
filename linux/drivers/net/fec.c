 ...
 * Copyrught (c) 2001 Greg Ungerer (gerg@lineo.com)
 */
...
/*
 *	Some architecture specific defines and macros.
 */
#ifdef CONFIG_M5272
...
int __init fec_enet_init(struct net_device *dev)
{
	...
	*/
	fecp->fec_mii_speed = fep->phy_speed = 0x07;
printk("%s(%d): setting MII speed to %x\n", __FILE__, __LINE__, (int) fecp->fec_mii_speed);
#else
